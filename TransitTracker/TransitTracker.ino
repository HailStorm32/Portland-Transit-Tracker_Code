...
struct redStationBounds
{
  ...
  const double LAT_DIFF_MIN[NUM_RED_STOPS] = {0.000295,0.000196,0.000276,0.000203,0.000125,0.000125,0.000200,0.000200,0.000125,0.000125,0.000200,0.000200,0.000350,0.000550,0.000550,0.000200,0.000200,0.000200,0.000200,0.000355,0.000455,0.000670,0.000600,0.000430,0.000290,0.000380,0.000320};
...
struct blueStationBounds
{
  ...
  const double LAT_DIFF_MIN[NUM_BLUE_STOPS] = {0.000380,0.000200,0.000150,0.000300,0.000250,0.000250,0.000250,0.000250,0.000250,0.000280,0.000300,0.000368,0.000236,0.000250,0.000295,0.000196,0.000276,0.000203,0.000125,0.000125,0.000200,0.000200,0.000200,0.000200,0.000125,
...
struct greenStationBounds
{
  ...
  const double LAT_DIFF_MIN[NUM_GREEN_STOPS] = {0.000430,0.000340,0.000320,0.000450,0.000395,0.000370,0.000420,0.000390,0.000390,0.000480,0.000420,0.000345,0.000290,0.000340,0.000200,0.000200,0.000200,0.000200,0.000355,0.000455,0.000670,0.000600,0.000670,0.000400,
...
struct yellowStationBounds
{
  ...
  const double LAT_DIFF_MIN[NUM_YELLOW_STOPS] = {0.000430,0.000450,0.000395,0.000420,0.000390,0.000420,0.000290,0.000289,0.000289,0.000850,0.000300,0.000715,0.000815,0.000785,0.000250,0.000335,0.000355};
...
struct orangeStationBounds
{
  ...
  const double LAT_DIFF_MIN[NUM_ORANGE_STOPS] = {0.000368,0.000375,0.000375,0.000570,0.000400,0.000400,0.000320,0.000150,0.000340,0.000150,0.000340,0.000450,0.000370,0.000390,0.000480,0.000345,0.000340};
...
void loop() {
    ...
    String url = "/ws/V2/vehicles/onRouteOnly/true/showStale/false/xml/true/routes/100/appID/";
    url += API_KEY;
